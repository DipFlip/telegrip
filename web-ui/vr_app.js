...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    // Controller tracking is now handled by the main VR button in vr.html
});

// Controller tracking button logic removed - now handled by the main VR button in vr.html 